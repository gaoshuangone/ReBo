...
- (void)initView:(CGRect)frame
{
    ...
    _listBackColor = [CommonFuction colorFromHexRGB:@"000000"];
    
    _listDownArrowImg = [UIImage imageNamed:@"LRprivateChatJiao"];
    _listUpArrowImg = [UIImage imageNamed:@"LRprivateChatJiaoUP"];
...
//    _backView.layer.borderColor = [CommonFuction colorFromHexRGB:@"000000"].CGColor;
...
//    [self addSubview:_backView];
    ...
    _listBtnImg = [[UIImageView alloc] initWithFrame:CGRectMake(frame.size.width - btnWidth, 0, 6, 4)];
...
- (void)createTableView
{
    if (_tableView == nil)
    {
        ...
        if ([self.strControllerNeeded isEqualToString:@"PrivateChatView"]) {
            _tableView.layer.borderWidth=0.5;
            _tableView.layer.borderColor=[[CommonFuction colorFromHexRGB:@"cbcbcb"]CGColor];
...
-(void)setIsDictDown:(BOOL)isDictDown{
    _isDictDown = isDictDown;
}
...
- (void)layoutSubviews
{
    ...
    _listBtnImg.frame = CGRectMake(self.frame.size.width - 10,  (_selectTextLable.frameHeight-self.listDownArrowImg.size.height)/2, self.listDownArrowImg.size.height , self.listDownArrowImg.size.height);
}
/*

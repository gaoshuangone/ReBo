...
@property (nonatomic, assign) NSInteger itemcont;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_cont == _itemcont) {
        ...
        cell.textLabel.textColor = [CommonFuction colorFromHexRGB: @"959596"];
    }
    _cont ++;
    return cell;
}

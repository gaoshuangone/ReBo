...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.shouldUnderline) {
        ...
        CGRect rect = [self.text boundingRectWithSize:CGSizeMake(self.frame.size.width, self.frame.size.height)
                                           options:NSLineBreakByTruncatingTail|NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading
                                        attributes:attribute context:nil];
   
        CGSize fontSize = rect.size;

...
- (void)initView:(CGRect)frame
{
    ...
    _viewLine = [CommonUtils CommonViewLineWithFrame:CGRectMake(CGRectGetMinX(_testFieldLiveSigeCount.frame), CGRectGetMaxY(_testFieldLiveSigeCount.frame)+8+2, SCREEN_WIDTH-CGRectGetMinX(_testFieldLiveSigeCount.frame)*2, 1)];     _viewLine.backgroundColor = [CommonFuction colorFromHexRGB:@"cbcbcb"];
    ...
    [_controlMiddleView addSubview:_imageViewJiao3];wq454

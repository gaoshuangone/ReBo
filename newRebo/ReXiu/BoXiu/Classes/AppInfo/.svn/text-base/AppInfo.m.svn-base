...
- (void)saveServerType:(NSInteger)type
{
    ...
    switch (type)
    {
        ...
        case 8:
        {
            self.serverBaseUrl = Sunny_SeverBaseUrl;
            self.requestServerBaseUrl = Sunny_Request_ServerBaseUrl;
            self.resourceBaseUrl = Sunny_ResourceBaseUrl;
            self.protocolUrl = Sunny_PROTOCOL_URL;
        }
            break;
            
        case 9:
        {
            self.serverBaseUrl = LuQi_SeverBaseUrl;
            self.requestServerBaseUrl = LuQi_Request_ServerBaseUrl;
            self.resourceBaseUrl = LuQi_ResourceBaseUrl;
            self.protocolUrl = LuQi_PROTOCOL_URL;
        }
            break;
        case 10:
        {
            self.serverBaseUrl = Sun_SeverBaseUrl;
            self.requestServerBaseUrl = Sun_Request_ServerBaseUrl;
            self.resourceBaseUrl = Sun_ResourceBaseUrl;
            self.protocolUrl = Sun_PROTOCOL_URL;
        }
            break;
        default:
            break;

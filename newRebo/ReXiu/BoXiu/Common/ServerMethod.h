...
#define Sunny_SeverBaseUrl              @"http://test.tan.51rexiu.cn:9292"//SUNNY服务器
#define Sun_SeverBaseUrl                @"http://test.sun.51rexiu.cn:9292"//SUN服务器
#define LuQi_SeverBaseUrl              @"http://test.lu.51rexiu.cn:9292"//SUNNY服务器
...
#define Sunny_Request_ServerBaseUrl     [NSString stringWithFormat:@"%@/%@",Sunny_SeverBaseUrl,Request_Suffix];
#define LuQi_Request_ServerBaseUrl     [NSString stringWithFormat:@"%@/%@",LuQi_SeverBaseUrl,Request_Suffix];
#define Sun_Request_ServerBaseUrl     [NSString stringWithFormat:@"%@/%@",Sun_SeverBaseUrl,Request_Suffix];
...
#define Sunny_ResourceBaseUrl           Test_ResourceBaseUrl
#define LuQi_ResourceBaseUrl            Test_ResourceBaseUrl
#define Sun_ResourceBaseUrl             Test_ResourceBaseUrl
...
#define Sunny_PROTOCOL_URL              Test_PROTOCOL_URL
#define LuQi_PROTOCOL_URL               Test_PROTOCOL_URL
#define Sun_PROTOCOL_URL                Test_PROTOCOL_URL
...
//七牛推流,获取推流JSON
#define GetStreamInfo_Method   @"chat/getStreamInfo.talent"

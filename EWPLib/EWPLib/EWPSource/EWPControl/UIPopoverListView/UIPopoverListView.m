...
- (void)defalutInit
{
    ...
    CGRect tableFrame = CGRectMake(1, 1, xWidth - 2, self.bounds.size.height - 2);
    ...
    _overlayView.backgroundColor = [UIColor clearColor];//[UIColor colorWithRed:.16 green:.17 blue:.21 alpha:.5];
...
- (void)show
{
    ...
    CGPoint center = CGPointMake(keywindow.bounds.size.width/2.0f,keywindow.bounds.size.height/2.0f);
    [self showInCenter:center];
}
